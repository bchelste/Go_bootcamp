...
func main() {
	...
	if (height != 0) {
		...
		fmt.Printf("areToysBalanced result: ")
		fmt.Println(areToysBalanced(randomTree))
	...
	fmt.Printf("areToysBalanced result: ")
	fmt.Println(areToysBalanced(exampleTree1))
	fmt.Println("-----------------------------")
	...
	fmt.Printf("areToysBalanced result: ")
	fmt.Println(areToysBalanced(exampleTree2))
	fmt.Println("-----------------------------")
	...
	fmt.Printf("areToysBalanced result: ")
	fmt.Println(areToysBalanced(exampleTree3))
	fmt.Println("-----------------------------")
	...
	fmt.Printf("areToysBalanced result: ")
	fmt.Println(areToysBalanced(exampleTree4))
	fmt.Println("-----------------------------")

	exampleSingleRoot := &TreeNode{false,nil,nil}
	outputTree(exampleSingleRoot)
	fmt.Printf("areToysBalanced result: ")
	fmt.Println(areToysBalanced(exampleSingleRoot))
	fmt.Println("-----------------------------")

	var exampleNilRoot *TreeNode = nil
	outputTree(exampleNilRoot)
	fmt.Printf("areToysBalanced result: ")
	fmt.Println(areToysBalanced(exampleNilRoot))
	fmt.Println("-----------------------------")
	...
	fmt.Printf("areToysBalanced result: ")
	fmt.Println(areToysBalanced(exampleTreeBig))
	fmt.Println("-----------------------------")
}
